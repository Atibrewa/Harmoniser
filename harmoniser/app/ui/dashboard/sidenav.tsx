...
export default function SideNav() {
  return (
    <div className="flex h-full flex-col px-3 py-4 md:px-2">
      <Link
        className="mb-2 flex h-20 items-end justify-center rounded-md bg-colours-1 p-4 md:h-40"
        href="/"
      >
      ...
      <div className="flex grow flex-col justify-between space-y-2 md:flex-col md:space-x-0 md:space-y-2">
        <VisualizerLinks />
        <div className="hidden h-auto w-full grow rounded-md bg-colours-2 md:block"></div>
      </div>
    </div>
  );
}
